...
Requires: flatten_json-license = %{version}-%{release}
...
%package license
Summary: license components for the flatten_json package.
Group: Default

%description license
license components for the flatten_json package.
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/flatten_json
cp %{_builddir}/flatten_json-0.1.13/LICENSE %{buildroot}/usr/share/package-licenses/flatten_json/6a22ee80346cfa8d9b987f2381bc8c390cb04352
...
/usr/share/package-licenses/flatten_json/6a22ee80346cfa8d9b987f2381bc8c390cb04352
